...
<div id="bgded1" class="wrapper bgded overlay">
  <div id="pageintro" class="hoc clear"> 
    <header>
      <p class="heading">Информационни технологии</p>
      <h2 class="heading orange-txt"><span class="block lightblue-txt">Бъдещето е в </span> НАС !</h2>
      <div class="header-bottom"><a href="#" class="silver-txt">Прочети повече &raquo;</a></div>
    </header>
  </div>
</div>
      ...
      <div class="table-row"> 
        ...
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-key"></i></a>
            ...
            <div class="article-bottom"><a href="#">Прочети повече &raquo;</a></div>
          </article>
        </div>
        <div class="table-cell">
          <article><a href="#"><i class="fa fa-lastfm"></i></a>
            ...
            <div class="article-bottom"><a href="#">Прочети повече &raquo;</a></footer>
          </article>
        </div>
        <div class="table-cell">
...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="center btmspace-80">
      ...
      <p class="nospace no-display">&fgdlgdgdfl gldfl gldfl glfld</p>
    </div>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div id="bgded2" class="wrapper bgded overlay">
  ...
  <section class="hoc container clear"> 
    ...
    <div class="group">
      <article class="one_third first"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="txt-align-justify">По това време езикът и платформата Java, изградени върху същите концепции, се радват на огромен успех във всички сфери на разработката на софтуер и разработката на C# и .NET е естественият отговор на Microsoft срещу успехите на Java технологията.</p>
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="txt-align-justify">Тъй като оригиналната версия на езика C# и платформата .NET са само за Windows се появява проекта Mono. 
      ...
      <article class="one_third"><a href="#"><img class="btmspace-30" src="images/demo/320x220.png" alt=""></a>
        ...
        <hr>
        <p class="txt-align-justify">Mono сваля бариерите за създаване на качествен софтуер за Linux с езика C#. 
