...
<div class="wrapper row3">
  <main class="hoc container clear"> 
    ...
    <div class="content three_quarter first"> 
      <h1>Kotlin</h1>
	  <p id="comic-con">Kotlin e статично-типизиран програмен език, който върви на Java виртуална машина и може да бъде компилиран заедно с JavaScript source code или да използва компилатор с LLVM* структура. Името идва от о-в Котлин, финския залив, в близост до Кронщад.
...
- И разбира се Android Studio.
    ...
    <div class="sidebar one_quarter"> 
      ...
      <div class="sdb_holder" id="sdb-holder">
        <ul>
